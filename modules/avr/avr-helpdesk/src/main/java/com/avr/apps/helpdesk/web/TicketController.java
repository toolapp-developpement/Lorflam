...
public class TicketController {
    ...
    public void joinSaleOrderAndStockMoveBy(ActionRequest request, ActionResponse response) throws AxelorException {
        ...
        List<PurchaseRequest> purchaseRequestList = ticketService.computedSequencePurchaseRequestIfNotExist(ticket.getPurchaseRequestList());
        List<StockMove> stockMoveList = ticketService.computedSequenceStockMoveIfNotExist(ticket.getStockMoveList());
        response.setValue("saleOrderSeq", ticketService.joinBy(saleOrderList, SaleOrder::getSaleOrderSeq));
        response.setValue("stockMoveSeq", ticketService.joinBy(stockMoveList, StockMove::getStockMoveSeq));
