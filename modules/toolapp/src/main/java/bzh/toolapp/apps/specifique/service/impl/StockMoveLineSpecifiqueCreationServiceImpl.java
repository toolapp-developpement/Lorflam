...
public class StockMoveLineSpecifiqueCreationServiceImpl extends StockMoveLineServiceSupplychainImpl
  ...
  @Inject
  public StockMoveLineSpecifiqueCreationServiceImpl(
  ...
  public StockMoveLine createStockMoveLine(
    ...
    if (product != null) {
      ...
      StockMoveLine stockMoveLine =
          generateStockMoveLineSpecifiqueConvertingUnitPrice(
              product,
              productName,
              description,
              quantity,
  ...
  protected StockMoveLine generateStockMoveLineSpecifiqueConvertingUnitPrice(
      Product product,
      String productName,
      String description,
      BigDecimal quantity,
