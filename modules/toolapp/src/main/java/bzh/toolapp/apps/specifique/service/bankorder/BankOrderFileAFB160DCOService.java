    ...
    try {
      ...
      senderRecordBuilder.append(
          cfonbToolService.createZone(
              ...
              cfonbToolService.FORMAT_ALPHA_NUMERIC,
              1));
      // Area D-3: Code etablissement bancaire du c�dant
      senderRecordBuilder.append(
          cfonbToolService.createZone(
              ...
              cfonbToolService.FORMAT_NUMERIC,
              5));
      // Area D-4: Code guichet du c�dant
      senderRecordBuilder.append(
          cfonbToolService.createZone(
              ...
              cfonbToolService.FORMAT_NUMERIC,
              5));
      // Area D-5: Num�ro de compte du c�dant
      senderRecordBuilder.append(
          cfonbToolService.createZone(
    ...
    try {
      ...
      mainDetailRecordBuilder.append(
          cfonbToolService.createZone(
              ...
              cfonbToolService.FORMAT_ALPHA_NUMERIC,
              24));
      // Area D-1: Domiciliation bancaire du tir�
      mainDetailRecordBuilder.append(
          cfonbToolService.createZone(
      ...
      mainDetailRecordBuilder.append(
          cfonbToolService.createZone(
              ...
              cfonbToolService.FORMAT_NUMERIC,
              5));
      // Area D-5: Num�ro de compte du tir�
      mainDetailRecordBuilder.append(
          cfonbToolService.createZone(
    ...
    try {
      ...
      additionalDetailRecordBuilder.append(
          cfonbToolService.createZone(
              ...
              cfonbToolService.FORMAT_ALPHA_NUMERIC,
              6));
      // Area C-1 Adresse du tir� : N� et nom de voie
      additionalDetailRecordBuilder.append(
          cfonbToolService.createZone(
              ...
              cfonbToolService.FORMAT_ALPHA_NUMERIC,
              32));
      // Area C-2 Adresse du tir� : Localit�
      additionalDetailRecordBuilder.append(
          cfonbToolService.createZone(
              ...
              cfonbToolService.FORMAT_ALPHA_NUMERIC,
              32));
      // Area C-3 Adresse du tir� : Code postale et bureau distributeur
      additionalDetailRecordBuilder.append(
          cfonbToolService.createZone(
  ...
  protected String getAdditionalC3Value(Address address, Partner partner) throws AxelorException {
    if (address == null) {
      throw new AxelorException(
          TraceBackRepository.CATEGORY_MISSING_FIELD,
          I18n.get(
              IExceptionSpecifiqueMessage.BANK_ORDER_RECEIVER_BANK_DETAILS_MISSING_PARTNER_ZIP),
          partner.getFullName());
    }
  ...
  protected String getAdditionalC2Value(Address address, Partner partner) throws AxelorException {
    if (address == null || address.getCity() == null) {
      throw new AxelorException(
          TraceBackRepository.CATEGORY_MISSING_FIELD,
          I18n.get(
              IExceptionSpecifiqueMessage.BANK_ORDER_RECEIVER_BANK_DETAILS_MISSING_PARTNER_CITY),
          partner.getFullName());
    }
  ...
  protected String getAdditionalC1Value(Address address, Partner partner) throws AxelorException {
    if (address == null) {
      throw new AxelorException(
          TraceBackRepository.CATEGORY_MISSING_FIELD,
          I18n.get(
              IExceptionSpecifiqueMessage.BANK_ORDER_RECEIVER_BANK_DETAILS_MISSING_PARTNER_ADDRESS),
          partner.getFullName());
    }
