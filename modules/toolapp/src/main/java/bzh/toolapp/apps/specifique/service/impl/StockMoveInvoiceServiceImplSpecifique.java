...
public class StockMoveInvoiceServiceImplSpecifique
    extends ProjectStockMoveInvoiceServiceImpl {
  ...
  public InvoiceLine createInvoiceLine(Invoice invoice, StockMoveLine stockMoveLine, BigDecimal qty)
    ...
    BigDecimal exTaxTotal = InvoiceLineManagement.computeAmount(invoiceLine.getQty(), invoiceLine.getPriceDiscounted());    
